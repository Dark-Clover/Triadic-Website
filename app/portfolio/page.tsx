...
import FlagScroller from "@/components/flag-scroller" // Import the new FlagScroller
...
const portfolioData = {
    ...
    ecommerce: [
      {
        ...
        image: "https://i.ibb.co/4Zg2tvbY/savvyy.png",
  ...
  "lead-generation": [
    // Placeholder for lead generation projects
    {
      ...
      description: "Enhanced Sales through Digital marketing and Lead Generation strategies",
      ...
      <section id="portfolio-categories" className="py-32 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-7xl mx-auto">
            {/* Removed "Our Work Categories" heading */}
            {/* Category Navigation */}
                ...
                {categories.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300", // Made bigger and more prominent
                        activeCategory === category.id
                          ? "bg-[#4a0072] text-white shadow-lg"
                          : "text-gray-300 hover:text-white hover:bg-white/10",
                      )}
                    >
                      <IconComponent className="h-6 w-6" /> {/* Increased icon size */}
                      {category.name}
                    </button>
                  )
                })}
