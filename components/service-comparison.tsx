        ...
        <div className="overflow-x-auto">
          ...
          <div className="md:hidden space-y-8">
            ...
            <div className="bg-[var(--primary-color)]/30 rounded-lg overflow-hidden relative">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-[var(--accent-color)] to-[var(--accent-color)]/80 text-white text-xs font-bold py-1.5 px-4 rounded-full shadow-lg shadow-[var(--accent-color)]/20 border border-[var(--accent-color)]/30 animate-pulse">
                MOST POPULAR
              </div>
